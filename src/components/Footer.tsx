...
const Footer = () => {
  return (
    <footer className="w-full border-t border-gray-200 py-8 bg-white">
      <div className="container flex flex-wrap justify-end items-center gap-x-6 gap-y-2 text-xs text-gray-500">
        ...
        <Link to="/feedback" className="hover:text-gray-900 hover:underline whitespace-nowrap">
          フィードバック
        </Link>
