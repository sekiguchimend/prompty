...
import { ChevronRight, Heart, MessageSquare, Eye, MoreHorizontal, BookOpen, Star, Calendar, BellOff, ShieldAlert, Ban } from 'lucide-react';
...
const UserProfilePage: React.FC = () => {
  ...
  const userData: UserData = {
    ...
    name: 'なみさ',
    displayName: 'なみさ',
    bio: '鍼灸師\nHSC/HSP 敏感・繊細な方に刺激の少ない経絡治療をしています。日々の想いを書きとめています。',
  ...
  const recentPosts: PostData[] = [
    ...
    {
      id: '3',
      title: 'スターオブザカラー☆お気に入りのファンデーションが製造中止になった',
